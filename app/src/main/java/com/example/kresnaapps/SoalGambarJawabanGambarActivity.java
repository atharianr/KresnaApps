...
public class SoalGambarJawabanGambarActivity extends AppCompatActivity {
    ...
    private void checkAnswer() {
        ...
        if (selectedAnswer.equals(currentQuestion.getAnswerStr())) {
            Toast.makeText(SoalGambarJawabanGambarActivity.this, "Benar!", Toast.LENGTH_SHORT).show();
            score++;
            ...
            salah++;
            Toast.makeText(SoalGambarJawabanGambarActivity.this, "Salah!", Toast.LENGTH_SHORT).show();
            //binding.tvScore.setText("Score: " + score);
            //binding.tvSalah.setText("Salah: " + salah);
    ...
    private void ambilSharedPrefs() {
        ...
        Toast.makeText(SoalGambarJawabanGambarActivity.this, String.valueOf(levelNumber), Toast.LENGTH_SHORT).show();
    }
    ...
    private void levelUpAdd() {
        ...
        if (difficulty.equals("easy") && levelAdd < 1) {
            levelAdd++;
            Toast.makeText(SoalGambarJawabanGambarActivity.this, String.valueOf(levelAdd), Toast.LENGTH_SHORT).show();
            saveSharedPrefs();
            startActivity(intent);
            finish();
